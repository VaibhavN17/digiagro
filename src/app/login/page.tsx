...
//       { id: 2, email: 'expert@digiagro.com', password: 'password', role: 'expert', name: 'Dr. Agriculture Expert' },
...
//         <h1 className={styles.title}>Login to DigiAgro</h1>
...
//           <p><strong>Farmer:</strong> farmer@digiagro.com / password</p>
//           <p><strong>Expert:</strong> expert@digiagro.com / password</p>
//           <p><strong>Admin:</strong> admin@digiagro.com / password</p>
//         </div>
//       </form>
//     </div>
//   );
