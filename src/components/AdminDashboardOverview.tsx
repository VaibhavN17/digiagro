...
export default function AdminDashboardOverview({ data }: { data: any }) {
  return (
    <div>
      <h2 style={{ marginBottom: '20px', color: '#2d5016' }}>Admin Dashboard Overview</h2>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 10px 0', color: '#495057' }}>New Registrations</h3>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 10px 0', color: '#495057' }}>Pending Approvals</h3>
